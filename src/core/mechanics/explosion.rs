            ...
            for _ in 0..15 {
                ...
                let id = commands
                    .spawn((
                        ...
                        TweenAnim::new(
                            Delay::new(Duration::from_millis(rng.random_range(1..2000))).then(
                                Tween::new(
                                    EaseFunction::Linear,
                ...
                if building.is_base {
                    // Add UiCmp to continue animation after jump to the EndGame state
                    commands.entity(id).insert(UiCmp);
                }
            }
        }
    }
